...
func (s *CaptainServer) InstallChart(req *tw_com_softleader_captainkube.InstallChartRequest, stream tw_com_softleader_captainkube.Captain_InstallChartServer) error {
	log := logrus.New()
