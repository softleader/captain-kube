...
func DeleteChart(log *logrus.Logger, url string, req *tw_com_softleader_captainkube.DeleteChartRequest, timeout int64) error {
	...
	if err != nil {
		return fmt.Errorf("could not delete chart: %v\n", err)
	}
	for {
